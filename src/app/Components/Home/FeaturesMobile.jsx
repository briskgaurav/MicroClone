...
export default function FeaturesMobile() {
  const orbs = [
    { size: "35", position: "top-[10%] left-[50%]" },
    { size: "22", position: "top-[50%] left-[38%]" },
    { size: "30", position: "top-[20%] left-[80%]" },
    { size: "15vw", position: "top-[70%] left-[50%]" },
  ];
  const data = [
    {
  ...
  return (
    <div className="h-fit  py-[20vw]  w-full relative z-10 overflow-x-hidden">
      <div className="absolute border-b  border-[#EBDFCA]  z-[-1] flex items-center justify-center top-0 left-0 w-full h-full">
        <div className="w-[70%] h-full flex items-center justify-center">
          <div className="w-[100%]  h-full flex flex-col items-center justify-evenly  border-[#EBDFCA]">
      ...
      <div className="px-[5vw]  h-full my-[8vw]   w-full ">
        <div className="w-full h-full  blocks-container ">
          {data.map((_, i) => (
            <div
              key={i}
              className={`flex items-center flex-col  blocks translate-y-[20%] mb-[25vw] ${
            ...
            >
              ...
              >
                <div className="h-[35vh] rounded-[4vw] w-full bg-[#14151A] p-5">
                  <svg
                    ref={refMessage}
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                ...
                <div className="px-4 py-[1vw]   w-full ">
                  <p className="text-[10vw] text-feature leading-[1.2] text-[#14151A] font-light font-haffer">
                    {_.title}
                  </p>
                  <p className="text-[4vw] mt-[1vw] text-feature text-[#14151A]/80 font-haffer">
                    {_.description}
                  </p>
                </div>
              </div>
