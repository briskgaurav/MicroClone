...
export default function Footer() {
  ...
  return (
    <div className="h-fit w-full flex flex-col items-center justify-center footer-container">
          ...
          <div className="absolute capsule bottom-0 left-0 w-full h-[92%] overflow-hidden bg-black rounded-full flex items-center justify-center px-[20%]">
            <div className="marquee-track translate-y-[-12%] flex flex-col gap-[5vw]">
              {[...data, ...data].map((testimonial, i) => (
                <div
                  key={i}
                  className="flex flex-col items-center gap-4 py-[5vw]"
                >
                  <Image
      ...
      <SwiperComponent />
      <div className="h-fit flex-col  border-t-2 border-[#EBDFCA] w-[75%]  gap-5  p-4 flex items-center justify-center">
      ...
      <div className="h-screen mt-[10vw] relative w-full flex">
        ...
        <div className="w-full px-[1vw] h-full flex flex-col    ">
          ...
          <div className="flex footer-text opacity-0 translate-y-[10%] items-center justify-between">
            <div className="flex items-start justify-start gap-8 py-[1vw]">
             ...
             >
               ...
               ></path>
                ...
                <div
                  key={index}
                  className="flex cursor-pointer w-[.6vw] items-center justify-center"
                >
                  <Link href={"/#"}>
                  {item}
                  </Link>
            ...
            <div className="flex items-center justify-start gap-[5vw] py-[1vw]">
              {["Contact Us", "Carrers", "Privacy", "Terms"].map(
                (item, index) => (
                  <div
                    key={index}
                    className="text-[.6vw] cursor-pointer text-black flex items-center justify-center gap-2"
                  >
                    <Link href={"/#"}>
          ...
          <div>
            <p className="font-pp uppercase text-black text-[.5vw]">
