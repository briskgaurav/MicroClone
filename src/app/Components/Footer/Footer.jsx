...
const data = [
  {
    ...
    company: "Superpower",
    image:
      "https://www.micro.so/_next/static/media/superpower.c8915e11.svg",
  },
  {
    ...
    company: "TechFlow",
    image:
      "https://www.micro.so/_next/static/media/shield.99c33afb.svg",
  },
]
...
export default function Footer() {
  ...
  return (
    <div className="h-fit w-full footer-container">
      <div className="h-[80vh] w-full px-[10vw] border-b-2 p-[2vw]  flex items-center justify-center border-[#EBDFCA]">
        <div className="w-[90%] rounded-full  relative border-2 border-[#EBDFCA] h-[80%]">
        <div className="absolute capsule bottom-0 left-0 w-full h-[92%] overflow-hidden bg-black rounded-full flex items-center justify-center px-[20%]">
  <div className="marquee-track translate-y-[-12%] flex flex-col gap-[5vw]">
    {[...data, ...data].map((testimonial, i) => (
      <div key={i} className="flex flex-col items-center gap-4 py-[5vw]">
        <Image
      ...
      <div className="h-fit flex-col gap-5 w-full p-4 flex items-center justify-center">
        <p className="text-[2.5vw] text-1 opacity-0 translate-y-[50%] text-center font-tobias text-[#14151A] tracking-tighter">
      ...
      {/* "FOOTER" */}
      <div className="h-screen mt-[10vw] relative w-full flex">
        <Image
          src={"/images/footer.webp"}
          alt="footer"
          width={1000}
          height={1000}
          className="w-full absolute z-[-1] bottom-0 left-0  h-full object-cover"
        />
        <div className="w-full px-[1vw] h-full flex flex-col    ">
          <div className="border-b pb-[.5vw] pt-[10vw] h-fit border-black w-full flex items-center justify-between opacity-0 footer-text translate-y-[10%] text-black text-[2vw] tracking-tighter leading-[1.2]">
            <p className="text-[4vw] font-haffer">Organized.</p>
            <p className="font-tobias text-[2vw]">So you don't have to be.</p>
          </div>
          <div className="flex footer-text opacity-0 translate-y-[10%] items-center justify-between">
            <div className="flex items-start justify-start gap-8 py-[1vw]">
              {[
                <svg
                ...
                <div
                  key={index}
                  className="flex w-[1vw] items-center justify-center"
                >
                  {item}
                </div>
              ))}
            </div>
            <div className="flex items-center justify-start gap-8 py-[1vw]">
              {["Contact Us", "Carrers", "Privacy", "Terms"].map(
                (item, index) => (
                  <div
                    key={index}
                    className="text-[.6vw] text-black flex items-center justify-center gap-2"
                  >
                    <p className="uppercase font-pp">{item}</p>
          ...
          <div>
            <p className="font-pp text-black text-[.6vw]">
